...
module.exports.defineMasterSlideTemplate = (pptx) => {
  pptx.defineSlideMaster({
    ...
    objects: [
      { 'image': { x: 6.2, y: 1.4, w: 0.31, h: 0.07, path: './images/dots.png' } },
    ...
    objects: [
      ...
      { 'text': { text: 'The Situation',
        options: { x: 0.57,
          ...
          color: 'FFFFFF' } } },
      { 'rect': { x: 0.57, y: 2.05, w: 11.5, h: 1.45, fill: 'F2F2F2' } },
      { 'image': { x: 10.75, y: 1.45, w: 2.2, h: 2.2, path: './images/amh.png' }, rounding: 'true' },
      { 'image': { x: 0.5, y: 3.75, w: 3.8, h: 0.92, path: './images/challenge.png' } },
      { 'image': { x: 4.70, y: 3.75, w: 3.9, h: 0.92, path: './images/solution.png' } },
      { 'image': { x: 8.9, y: 3.75, w: 3.9, h: 0.92, path: './images/results.png' } },
      { 'image': { x: 4.5, y: 4.67, w: 0.04, h: 2.3, path: './images/vertical.png' } },
    ...
    objects: [
      ...
      { 'text': { text: 'The Situation',
        options: { x: 0.57,
          ...
          color: 'FFFFFF' } } },
      { 'rect': { x: 0.57, y: 2.05, w: 11.5, h: 1.45, fill: 'F2F2F2' } },
      { 'image': { x: 10.75, y: 1.45, w: 2.2, h: 2.2, path: './images/ie.png' }, rounding: 'true' },
      { 'image': { x: 0.5, y: 3.75, w: 3.8, h: 0.92, path: './images/challenge.png' } },
      { 'image': { x: 4.70, y: 3.75, w: 3.9, h: 0.92, path: './images/solution.png' } },
      { 'image': { x: 8.9, y: 3.75, w: 3.9, h: 0.92, path: './images/results.png' } },
      { 'image': { x: 4.5, y: 4.67, w: 0.04, h: 2.3, path: './images/vertical.png' } },
...
module.exports.createSlide = (pptx, study, title, callback) => {
  ...
  slide.addText(study.projectName, { x: 0.0,
    y: 0.22,
    w: 13.3,
    h: 0.45,
    fontFace: 'Arial',
  ...
  slide.addText(study.situation, { x: 0.58,
    ...
    color: '000000',
    valign: 'top' })
  slide.addText(study.challenges, { x: 0.6,
    y: 4.72,
    w: 3.4,
    h: 2.1,
    align: 'left',
    ...
    valign: 'top',
    bullet: { code: '25AA' } })
  slide.addText(study.solution, { x: 4.8,
    y: 4.72,
    w: 3.4,
    h: 2.1,
    align: 'left',
    ...
    valign: 'top',
    bullet: { code: '25AA' } })
  slide.addText(study.provenResults, { x: 9.0,
    y: 4.72,
    w: 3.4,
    h: 2.1,
    align: 'left',
