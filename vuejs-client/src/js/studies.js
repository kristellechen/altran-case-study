module.exports = {
  ...
  getStudies () {
    return [{
      'ID': 1,
      'Client': 'Abaxis',
      'Project Name': 'HL7 Interface Development',
      'Year': 2015,
      'Brand': 'Foliage',
      ...
      'Engagement Type': 'Software Development',
      'Discipline': 'Software, Test',
      'Technologies': '',
      'Keyword Lookup': 'HL7, Class II, EMR',
      ...
      'Project Summary': 'Leading diagnostic medical device company needed a solution to enable existing devices to send HL7 data to EMRs.',
      'Project Team': 'Matt Eisedrath, Peter Rudolph',
      'Images': 0
    },
    {
      'ID': 2,
      'Client': 'Abbott Diabetes',
      'Project Name': 'Next Generation Hospital Glucose Meter and Data Management System',
      'Year': '(Pre 2009)',
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'MedTech',
      'Services': 'Project Management, Requirements Definition, Design, Development, Verification',
      'Project/ Application Type': 'Embedded',
      'Engagement Type': '',
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'HL7, Class II, EMR, HIS',
      ...
      'Project Summary': 'Manufacturer of hospital-based diabetes blood glucose monitors and glucose meters needed update to hospital-based meters and new data management system. Foliage developed Class II data management system designed to receive data from a point-of-care device',
      'Project Team': 'Greg Walsh, John Carey',
      'Images': 0
    },
    {
      'ID': 3,
      'Client': 'Abbott Molecular',
      'Project Name': 'Platform Upgrade & Migration',
      'Year': 2015,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'HIT',
      'Services': 'Project Management, Development, Test',
      'Project/ Application Type': 'Enterprise',
      'Engagement Type': 'Software Development',
      'Discipline': 'Software',
      'Technologies': 'Enterprise',
      'Keyword Lookup': 'Migration, Code, Platform, Upgrade, Windows XP, Windows 7',
      ...
      'Project Summary': 'Windows XP migration to Windows 8.1, creation of Windows 8.1 Embedded Image, Verification testing of the code',
      'Project Team': 'Dave Widland, Kevin Petriel',
      'Images': 0
    },
    {
      'ID': 4,
      'Client': 'Advantest',
      'Project Name': 'Advanced Analytics for Error Detection During Chip Design',
      'Year': 2016,
      'Brand': 'Foliage',
      ...
      'Services': 'Consulting',
      'Project/ Application Type': '',
      'Engagement Type': 'Product Consulting',
      'Discipline': 'Consulting, Analytics',
      'Technologies': '',
      'Keyword Lookup': 'Data Analytics, Semiconductor, ATE, Automated Test Equipment, Chip Design',
      ...
      'Project Summary': 'A leading semiconductor company is trying to prove that advanced analytics can be used during chip design and development to detect design errors and optimize chip operations to vastly shorten the design cycle.',
      'Project Team': 'Aamir Chaudhry and Scott Evans\nGerman Analytics Team – Rich Sanford',
      'Images': 0
    },
    {
      'ID': 5,
      'Client': 'AgaMatrix',
      'Project Name': 'Mobile Application for Diabetes Data Management',
      'Year': 2011,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'HIT',
      'Services': 'Design, Development',
      'Project/ Application Type': 'Embedded, Data',
      'Engagement Type': 'Software Development',
      'Discipline': '',
      'Technologies': 'iOS',
      'Keyword Lookup': 'iOS, ADA, UI, Software',
      ...
      'Project Summary': 'As a development partner Foliage helped to develop an important mobile data management system for diabetics managing this chronic disease.',
      'Project Team': 'John Carey, Greg Walsh',
      'Images': 0
    },
    {
      'ID': 6,
      'Client': 'Amgen',
      'Project Name': 'Product Design History File and Requirements Remediation',
      'Year': '',
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'MedTech',
      'Services': 'ESS',
      'Project/ Application Type': 'Requirements Remediation',
      'Engagement Type': 'System Development',
      'Discipline': 'EE, EM, Systems Test, Consulting',
      'Technologies': '',
      'Keyword Lookup': '62304, Remediation, FDA, Process Gap Assessment',
      ...
      'Project Summary': 'Due to changes in the regulatory environment, several commercial dermatological laser systems came to be regarded as medical devices.  Manufacturer needed to reverse engineer the devices to achieve IEC 62304 compliance.',
      'Project Team': 'Mark Hersey',
      'Images': 0
    },
    {
      'ID': 7,
      'Client': 'Applied Materials',
      'Project Name': 'Cost Reduction of Etch Tool',
      'Year': '',
      'Brand': 'Foliage',
      'Industry': 'Intelligent Manufacturing Solutions',
      'Sector': 'Semiconductor Equipment',
      'Services': 'ESS',
      'Project/ Application Type': 'Value Engineering',
      'Engagement Type': 'System Development',
      'Discipline': '',
      'Technologies': 'Finite Element Analysis',
      'Keyword Lookup': 'AMAT, Cost Reduction, Etch Tool, AC Box',
      ...
      'Project Summary': 'Global company developing high precision manufacturing equipment for the semiconductor industry must meet corporate goal to reduce product costs by 20%. Chamber cooling manifold identified as individual subcomponent for significant cost reduction.',
      'Project Team': 'Myron Pugh, Lee Plovnick, Chuck Shafer',
      'Images': 0
    },
    {
      'ID': 8,
      'Client': 'Arkray',
      'Project Name': 'Cloud-based Diabetes Management System',
      'Year': 2015,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'HIT',
      ...
      'Discipline': 'Software',
      'Technologies': '',
      'Keyword Lookup': 'Diabetes, Cloud, Enterprise, Cybersecurity',
      ...
      'Proven Results': 'Cybersecurity assessment model quantified risks and enabled appropriate security controls that complied with FDA cybersecurity guidance\n\nNew cloud-based solution improved usability for patients  and providers\n\nEncryption technology secured only sensitive',
      ...
      'Project Summary': 'A patient-centric diabetes products company looking to develop a secure cloud-based diabetes management system. Existing system was outdated, challenging for patients to use and didn’t meet latest FDA cybersecurity guidance.',
      'Project Team': 'Adam Hesse',
      'Images': 0
    },
    {
      'ID': 9,
      'Client': 'BioSignal',
      'Project Name': 'Application Migration to the Cloud',
      'Year': 2014,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'HIT',
      ...
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'Migration, Cloud, Enterprise, Biology, Neurology',
      ...
      'Project Summary': 'Migration strategy to merge multiple disparate HIS software systems to a new architecture',
      'Project Team': 'Adam Hesse, John, Carey, Greg Walsh',
      'Images': 0
    },
    {
      'ID': 10,
      'Client': 'Bruker',
      'Project Name': 'Bacterial Analysis & Microorganism ID System',
      'Year': '',
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'MedTech',
      ...
      'Technologies': '',
      'Keyword Lookup': 'LIM, Connectivity, Lab & Test, Workflow Management',
      ...
      'Project Summary': 'Biotechnology division of a global R&D company must address connectivity limitations with current ID system in order to expand market share. The solution must enable two devices   to exchange necessary worklists and results.',
      'Project Team': 'Tim Bosch, Madeline Shattow',
      'Images': 0
    },
    {
      'ID': 11,
      'Client': 'Cepheid',
      'Project Name': 'Diagnositc Device Cloud Solution',
      'Year': 2014,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'HIT',
      ...
      'Discipline': 'Systems',
      'Technologies': '',
      'Keyword Lookup': 'EMR, Cloud, Cybersecurity, Connectivity, LIS, IoT',
      ...
      'Project Summary': 'A leading molecular diagnostic company selected Foliage to develop a migration strategy and roadmap for moving their solution to the cloud.  The architecture leveraged cloud based platforms from BaaS providers in order to move software applications, remot',
      'Project Team': "Norm Haas, Dan O'Connor, Adam Hesse",
      'Images': 0
    },
    {
      'ID': 12,
      'Client': 'Covidien (Mallinckrodt)',
      'Project Name': 'Contrast Injector System Development',
      'Year': 2013,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'MedTech',
      'Services': 'Requirements Definition, Design, Development',
      'Project/ Application Type': 'Systems, Control',
      'Engagement Type': 'Software Development',
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'Software, Product Costs, Development, Electrical, Mechanical',
      ...
      'Project Summary': 'Developed complete contrast agent injector for the medical market including system design, mechanical system, electronic controls and software',
      'Project Team': 'John Carey, Chris Miles',
      'Images': 0
    },
    {
      'ID': 13,
      'Client': 'Drew Scientific',
      'Project Name': 'Whole Blood HbA1c Analyzer',
      'Year': 2011,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'MedTech',
      ...
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'SOM, Touchscreen, Fluidics, Ion-exchange, Chromatography, 3 Axis Stepper, Driven Sample, Loading Automation',
      ...
      'Project Summary': 'Developed prototype HbA1c analyzer product including electro-mechanical and control software.',
      'Project Team': 'John Carey, Dave Warburton',
      'Images': 0
    },
    {
      'ID': 14,
      'Client': 'Evoke',
      'Project Name': 'Web-based Portal for Wireless Wearable Sensor',
      'Year': 2012,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'HIT',
      ...
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'Data Analytics, Software, Connectivity, Scalability',
      ...
      'Proven Results': 'Collaborative approach introduced best practices to ensure the efficient use of \u000bin-house resources during development projects\n\nScalable software architecture provided solid framework for future development initiatives\n\nAchieved 80-90% time savings with',
      ...
      'Project Summary': 'A start-up neuroscience company with a wireless device for health monitoring seeking new service-based\nbusiness model for their innovative approach to controlling data quality in diagnosis reporting.\nPrimary objectives for the solution included developing',
      'Project Team': 'Matt Eisedrath',
      'Images': 0
    },
    {
      'ID': 15,
      'Client': 'Evoke',
      'Project Name': 'Portable ECG Monitor',
      'Year': '',
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'MedTech',
      ...
      'Technologies': '',
      'Keyword Lookup': 'Data Analytics, Portable EEG System, HRV, ECG',
      ...
      'Project Summary': 'Start-up company wants to develop a new portable EEG system for brain assessment in the field. They need support to take them from concept to product commercialization in a short period of time.',
      'Project Team': 'John Carey, Dave Meyers',
      'Images': 0
    },
    {
      'ID': 16,
      'Client': 'FEI',
      'Project Name': 'High Performance Measurement System (Dual beam SEM)',
      'Year': '',
      'Brand': 'Foliage',
      'Industry': 'Intelligent Manufacturing Solutions',
      ...
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'Semiconductor, Software, Dual Beam SEM, Architecture Assement',
      ...
      'Project Summary': 'Leading global provider of measurement systems looking to increase market share  in semiconductor equipment market faced customer pressures to enhance product features. Current product suffering debilitating reliability issues each time new features are a',
      'Project Team': "Dan O'Connor, Scott Evans",
      'Images': 0
    },
    {
      'ID': 17,
      'Client': 'Gerber',
      'Project Name': 'Next Generation Textile Cutter Control System',
      'Year': 2010,
      'Brand': 'Foliage',
      'Industry': 'Intelligent Manufacturing Solutions',
      'Sector': 'Discrete Manufacturing',
      'Services': 'Consulting, Design, Development, Test',
      'Project/ Application Type': 'Embedded, Controls',
      'Engagement Type': 'System Development',
      'Discipline': 'Hardware and Software',
      'Technologies': 'C#, Windows CE',
      'Keyword Lookup': 'Migration, Control System, Motion Control, Product Line, Acquisition',
      ...
      'Project Summary': 'Manufacturer of industrial cutting machines looking to develop next generation textile cutter control system with scalable architecture to enable faster delivery of new product enhancements. Development efforts constrained by complications arising from mu',
      'Project Team': 'Tom Mariano\nRick Flanders\nScott Evans',
      'Images': 0
    },
    {
      'ID': 18,
      'Client': 'GSI (Now ESI)',
      'Project Name': 'Laser Marking Control System',
      'Year': '',
      'Brand': 'Foliage',
      'Industry': 'Intelligent Manufacturing Solutions',
      'Sector': 'Discrete Manufacturing',
      ...
      'Technologies': '',
      'Keyword Lookup': 'Migration, Architecture Strategy, VDA, Manufacturing, Off-Shore, On-Shore',
      ...
      'Project Summary': 'Global leader in laser precision technology developing next generation laser marker control system with architecture that can support product enhancements and new technologies. Urgent need to improve performance to sustain market position while developing',
      'Project Team': 'Tim Bowe, Karl Aeder',
      'Images': 0
    },
    {
      'ID': 19,
      'Client': 'Harvest Automation',
      'Project Name': 'Fleet Management System for Autonomous Material Handling',
      'Year': 2015,
      'Brand': 'Foliage',
      'Industry': 'Intelligent Manufacturing Solutions',
      'Sector': 'AMH',
      ...
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'Fleet Control Management, Robotics, Retail Distribution, Time to Market',
      ...
      'Project Summary': 'A material handling company focused on robotics looking to enter the e-commerce retail distribution and fulfillment arena with a solution to improve efficiency and productivity in the pick-to-order space. Company looking for assistance to leverage existin',
      'Project Team': 'Aamir Chaudhry',
      'Images': 0
    },
    {
      'ID': 20,
      'Client': 'Heartware',
      'Project Name': 'LVAD Controller and Monitor',
      'Year': 2012,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'MedTech',
      'Services': 'Requirements Definition, Design, Development',
      'Project/ Application Type': 'Control',
      'Engagement Type': 'Process Consulting',
      'Discipline': 'Systems Test',
      'Technologies': '',
      'Keyword Lookup': 'Control System, Next-Generation Device, LVAD, Implantable, Test processes',
      ...
      'Project Summary': 'LVAD device manufacturer that is CE approved and sold in Europe wants to enter the U.S. market. Device needs Class III approval and they are up against a tight 18-month plan to commercialize the product.',
      'Project Team': 'John Carey, Matt Eisendrath, John Montrone, Alan Walsh, Peter Ferguson',
      'Images': 0
    },
    {
      'ID': 21,
      'Client': 'Intelligrated',
      'Project Name': 'Warehouse Control System Architecture',
      'Year': '',
      'Brand': 'Foliage',
      'Industry': 'Intelligent Manufacturing Solutions',
      'Sector': 'AMH',
      ...
      'Technologies': '',
      'Keyword Lookup': 'IoT, Warehouse Automation, Assessment, Architecture Definition',
      ...
      'Project Summary': 'Due to a shift in the marketplace driven by e-commerce and omni-channel demand, the manufacturer of automated warehouse solutions must deliver a next-generation system with real-time adaptive workflows to optimize fulfillment operations. A highly configur',
      'Project Team': 'Amit Shah, Scott Evans',
      'Images': 0
    },
    {
      'ID': 22,
      'Client': 'Keurig',
      'Project Name': 'Consumer Device IoT Platform',
      'Year': 2015,
      'Brand': 'Foliage',
      'Industry': 'Intelligent Manufacturing Solutions',
      ...
      'Technologies': '',
      'Keyword Lookup': 'Software, IoT, Wireless, Embedded, Systems',
      ...
      'Project Summary': 'Manufacturer of beverage brewing systems facing intense pressure to add features and functionality that leverage the IoT. Need help identifying the most compelling features and functionality to appeal to new and existing customers',
      'Project Team': 'Tom Mariano',
      'Images': 0
    },
    {
      'ID': 23,
      'Client': 'KLA - Tencor',
      'Project Name': 'Improved Data Handling Solution for Metrology',
      'Year': 2015,
      'Brand': 'Foliage',
      'Industry': 'Intelligent Manufacturing Solutions',
      'Sector': 'Semiconductor Equipment',
      'Services': 'Project Management, Design, Development, Test',
      'Project/ Application Type': 'Data',
      'Engagement Type': 'Software Development',
      'Discipline': 'Software, Test',
      'Technologies': 'MongoDB',
      'Keyword Lookup': 'Big Data',
      ...
      'Keywords': 'Big Data',
      'Project Summary': 'A global provider of process measurement and control, yield management and data analysis solutions for semiconductor manufacturing faced with making major improvements to an existing product. Customer requests driving enhancements to the capabilities and',
      'Project Team': 'Norm Haas',
      'Images': 0
    },
    {
      'ID': 24,
      'Client': 'L-3 Communications Security Detection',
      'Project Name': 'High-energy X-ray Large Cargo Screening System',
      'Year': 2012,
      'Brand': 'Foliage',
      ...
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'X-Ray, Scanning System, Security, Mobile',
      ...
      'Project Summary': 'Developed control software and hardware for a high-energy X-ray scanning system for large cargo containers. The full system was designed to be a fully mobile system',
      'Project Team': 'Jay Gray, David Martin',
      'Images': 0
    },
    {
      'ID': 25,
      'Client': 'McKesson',
      'Project Name': 'Advanced Population Health Solution',
      'Year': 2014,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'HIT',
      'Services': 'Consulting',
      'Project/ Application Type': 'Architecture, Big Data, Analytics, Platform Strategy',
      'Engagement Type': 'Product Consulting',
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'Platform, Big Data, Analytics',
      ...
      'Project Summary': 'Fortune 100 healthcare company needs to develop an advanced population health solution to address the market’s value-based reimbursement structure. Existing population health market        is highly fragmented, without a dominate product suite.',
      'Project Team': 'Tim Bosch, Matt Eisendrath',
      'Images': 0
    },
    {
      'ID': 26,
      'Client': 'McKesson',
      'Project Name': 'Data Management System Architecture',
      'Year': 2015,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'HIT',
      ...
      'Project/ Application Type': '',
      'Engagement Type': 'Systems Development, Process Consulting',
      'Discipline': 'Consulting',
      'Technologies': '',
      'Keyword Lookup': 'Roadmap, Security, Data Management, Architecture Platform',
      ...
      'Project Summary': 'Provider of pharmacy services needs to significantly expand patient data management and analytic capabilities. The current solution and technology are insufficient to meet increasing  data volumes, data sources, number of customer and      analytic needs.',
      'Project Team': 'Tim Bosch, Matt Eisendrath',
      'Images': 0
    },
    {
      ...
      'Project Name': 'Intra-operative Surgical Imaging System',
      'Year': 2009,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'MedTech',
      ...
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'Software, Design',
      ...
      'Proven Results': 'Implemented and tested refactored software control architecture solving reliability issues, improving system performance and resolving customer satisfaction challenges\n\nImproved architecture provided stronger foundation upon which to build new product fea',
      ...
      'Project Summary': 'Assessed existing control software for an x-ray-based intrasurgical imaging system. Subsequently were engaged to provide a recommendation for a new software control architecture which would improve overall system reliability.',
      'Project Team': "Tim Bowe, Dan O'Connor",
      'Images': 0
    },
    {
      'ID': 28,
      'Client': 'Novartis',
      'Project Name': 'Companion Diagnostic (CDx) Platform Strategy',
      'Year': 2013,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'MedTech',
      'Services': 'Consulting, Development',
      'Project/ Application Type': 'Class III, Product Platform, Architecture Strategy',
      'Engagement Type': 'Software Development',
      'Discipline': 'Software',
      'Technologies': '',
      'Keyword Lookup': 'Architecture Strategy, Lab & Test, Drug Development, Product Platform',
      ...
      'Proven Results': 'New platform streamlined and improved the data acquisition and analysis process\n\nAutomated process reduced analysis time and errors\n\nCommon platform now supports all drug trials',
      ...
      'Project Summary': 'Leading pharmaceutical company looking to automate the acquisition and analysis of clinical trial data. They need an approach that will help them streamline work processes to increase workflow efficiency and improve data quality and integrity.',
      'Project Team': 'Tim Bosch',
      'Images': 0
    },
    {
      'ID': 29,
      'Client': 'PepsiCo',
      'Project Name': 'Universal Liquid Dispensing System',
      'Year': 2013,
      'Brand': 'Foliage',
      'Industry': 'Intelligent Manufacturing Solutions',
      'Sector': 'Discrete Manufacturing',
      'Services': 'Consulting, Design, Development, Test, Project Management',
      'Project/ Application Type': 'Hardware',
      'Engagement Type': 'System Development',
      'Discipline': 'ME, Test',
      'Technologies': '',
      'Keyword Lookup': 'Manufacturing, Hardware, Beverage Filler Valve, Consumer Goods, Food and Beverage, Systems',
      ...
      'Project Summary': 'Beverage dispensing facilities must rapidly modify existing production process without down time. Developing a universal liquid dispensing system to accurately dispense a range of fluid viscosities and inclusions at high speeds in a corrosive environment',
      'Project Team': 'David Martin, Dave Warburton, Tom Evans',
      'Images': 0
    },
    {
      'ID': 30,
      'Client': 'Philips',
      'Project Name': 'Cloud-Based Portal for Mobile Imaging Device',
      'Year': 2012,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'HIT',
      ...
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'Cloud, Imaging, Mobile, Cloud Based Portal',
      ...
      'Proven Results': 'Created end-to-end working prototype with GUI features integrated with functional backend logic and services providing connectivity to the cloud\n\nProject completion in 90 days allowed client to maintain competitive timelines\n\nIdentified opportunities for',
      ...
      'Project Summary': 'A global medical device manufacturer looking to differentiate by introducing a mobile imaging device for use outside of traditional healthcare facilities.  Primary objective was to rapidly build a cloud-based portal allowing a mobile device to send images',
      'Project Team': '',
      'Images': 0
    },
    {
      'ID': 31,
      'Client': 'Sanmina SCI',
      'Project Name': 'Biopsy Imaging System',
      'Year': 2014,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'MedTech',
      ...
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'Imaging, Sanmina, Value Engineering, DFMA',
      ...
      'Proven Results': 'Achieved 32% cost reduction on components resulting in overall sustaining cost savings\n\nResolved thermal issues by redistributing power to the device\n\nROI achieved in 14 months',
      ...
      'Project Summary': 'Biopsy Imaging system product cost too high with complex assembly and service processes, the service time drives low customer-perceived quality, and thermal issues inside cabinet.',
      'Project Team': 'Carl Blahut, Myron Pugh',
      'Images': 0
    },
    {
      'ID': 32,
      'Client': 'SET Corporation',
      'Project Name': 'Counter Bomber Surveillance System',
      'Year': 2009,
      'Brand': 'Foliage',
      'Industry': 'Aerospace & Defense',
      'Sector': 'Government Systems',
      'Services': 'Development, Test',
      'Project/ Application Type': 'Commercial, ITAR Regulated, Windows CE, Python, Java, C++',
      'Engagement Type': '',
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'Software, Development, Systems, Integration and Test',
      ...
      'Project Summary': 'The client had a working prototype that was developed in a research environment. The system software was built and deployed by a collection of manual processes. There was no formal test plan or procedure to verify system operations.',
      'Project Team': '',
      'Images': 0
    },
    {
      'ID': 33,
      'Client': 'SICK, Inc.',
      'Project Name': 'Enterprise Analytics Software for Logistics Management',
      'Year': 2015,
      'Brand': 'Foliage',
      'Industry': 'Intelligent Manufacturing Solutions',
      'Sector': 'AMH',
      ...
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'Big Data, Logistics Management, Package Analytics, Sensors, Consulting',
      ...
      'Project Summary': 'A solution provider for logistics automation looking to differentiate themselves in a crowded marketplace must deliver an enterprise level software platform. New platform must bring large amounts of real-time data from facility to enterprise level to enab',
      'Project Team': 'Norb Gravelle, Roger Kerns,  Aamir Chaudhry',
      'Images': 0
    },
    {
      'ID': 34,
      'Client': 'Siemens',
      'Project Name': 'Predictive Maintenance Strategy and Implementation',
      'Year': 2016,
      'Brand': 'Foliage',
      'Industry': 'Intelligent Manufacturing Solutions',
      'Sector': 'Semiconductor Equipment',
      ...
      'Project/ Application Type': '',
      'Engagement Type': 'Analytics',
      'Discipline': 'Consulting and Analytics',
      'Technologies': '',
      'Keyword Lookup': 'Data Analytics, Analytics, Predictive Maintenance, Remote Diagnostics',
      ...
      'Project Summary': 'Global capital equipment supplier dealing with high warranty and service costs for thousands of units running in the field. Predictive analytics could be a viable solution for driving costs down, but the current data handling solution is incapable of proc',
      'Project Team': 'German analytics team',
      'Images': 0
    },
    {
      'ID': 35,
      'Client': 'Stereotaxis',
      'Project Name': 'Multi-function Display for Surgical Navigation System',
      'Year': '(Pre 2009)',
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'MedTech',
      ...
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'FDA, Robotics, Cardiac, Magnetic, Value Driven Analysis, Technology Strategy, Radiation',
      ...
      'Project Summary': 'Global manufacturer of robotics systems for the treatment of cardiac arrhythmias to develop a remote magnetic navigation system for cardiac catheterization, reducing physicians’ exposure to radiation during fluoroscopy procedures',
      'Project Team': '',
      'Images': 0
    },
    {
      'ID': 36,
      'Client': 'SureWx',
      'Project Name': 'Migration to Cloud ASP',
      'Year': 2014,
      'Brand': 'Foliage',
      'Industry': 'Aerospace & Defense',
      'Sector': 'Commerical Development',
      'Services': 'Consulting',
      'Project/ Application Type': 'Deicing, Weather, Airlines, Cloud, Fault Tolerant',
      'Engagement Type': '',
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': '',
      ...
      'Project Summary': 'Early corporate focus on the design , manufacturing and deployment of Weather Station Hardware. Business model switched to that of an Application Service Provider. Prototype application and hosting center both need major upgrade to support the planned rap',
      'Project Team': 'Ari Berman, Charlie Alfred, Michael Dixon',
      'Images': 0
    },
    {
      'ID': 37,
      'Client': 'Symbotic',
      'Project Name': 'System Mixed Pallet Building',
      'Year': 2012,
      'Brand': 'Foliage',
      'Industry': 'Intelligent Manufacturing Solutions',
      'Sector': 'AMH',
      ...
      'Keywords': '',
      'Project Summary': 'An automated material handling solution provider developing a new mixed pallet building system within a very tight market window. Solution must provide fast re-planning, greater efficiency and control while allowing for customization to meet future busine',
      'Project Team': 'Tom Mariano, Jeff Liscouski',
      'Images': 0
    },
    {
      'ID': 38,
      'Client': 'Symbotic',
      'Project Name': 'Warehouse Automation & Control System',
      'Year': 2013,
      'Brand': 'Foliage',
      'Industry': 'Intelligent Manufacturing Solutions',
      'Sector': 'AMH',
      ...
      'Keywords': 'WCS',
      'Project Summary': 'Company developing a new warehouse automation system faced aggressive time-to-market deadline to satisfy customer requirements. This solution would improve warehouse operational parameters such as storage density, inventory traceability and throughput cyc',
      'Project Team': 'Tom Mariano, Jeff Liscouski',
      'Images': 0
    },
    {
      'ID': 39,
      'Client': 'TransEngen',
      'Project Name': 'Pharmacy Benefit Verification System',
      'Year': 2013,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'HIT',
      ...
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'Cloud, Cybersecurity, Service Oriented Architecture, Pharmacy',
      ...
      'Project Summary': 'Foliage was selected to develop a web based platform to be used by Pharmaceutical companies for investigating insurance reimbursements for new drugs.  The system interfaces with > 450 insurance companies to query reimbursement information, and processes t',
      'Project Team': 'Adam Hesse',
      'Images': 0
    },
    {
      'ID': 40,
      'Client': 'Varian',
      'Project Name': 'Amorphous Silicon Digital X-Ray Imager',
      'Year': '',
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'MedTech',
      ...
      'Keyword Lookup': 'X-Ray, Product Architecture, Platform Architecture',
      ...
      'Project Summary': 'X-ray tube and imager manufacturer developing a low cost imaging panel for dental X-rays - needs help developing product architecture, conceptual design and initial fabrication of product',
      'Project Team': '',
      'Images': 0
    },
    {
      'ID': 41,
      'Client': 'Viewray',
      'Project Name': 'Radiation Therapy Control System',
      'Year': 2011,
      'Brand': 'Foliage',
      'Industry': 'Medical & Life Sciences',
      'Sector': 'MedTech',
      ...
      'Discipline': '',
      'Technologies': '',
      'Keyword Lookup': 'FDA, Cancer, Imaging, 501 (k), Oncology',
      ...
      'Proven Results': 'New radiation therapy control system delivered in time for performance demonstration\n\nAdditional Beta test sites arranged\n\nEnabled the start of 510(k) submission to FDA',
      ...
      'Project Summary': 'Combine real-time imaging and radiation therapy system for cancer treatment. Challenge: The majority of the system was built but the control system was late and over budget threatening the entire program. System assessment, Planning, Development\n2 write-u',
      'Project Team': 'Dan Goldman, Greg Walsh',
      'Images': 0
    },
    {
      'ID': 42,
      'Client': 'Zygo',
      'Project Name': 'Lithography Lens Metrology System',
      'Year': 2007,
      'Brand': 'Foliage',
      'Industry': 'Intelligent Manufacturing Solutions',
      'Sector': 'Semiconductor Equipment',
      ...
      'Discipline': 'Software, Test',
      'Technologies': '',
      'Keyword Lookup': 'Time to Market, Lens Surface, Accuracy, 3D Mapping',
      ...
      'Project Summary': 'Global supplier of optical metrology instruments must deliver new innovative product to meet customer need under extremely tight time constraints. This new product uses 3D mapping to characterize a lens surface requiring a level of accuracy that had never',
      'Project Team': 'Rick Flanders, Tom Mariano',
      'Images': 0
    }
    ]
  }
